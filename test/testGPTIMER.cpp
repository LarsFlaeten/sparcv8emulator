...
TEST_F(GPTIMERTest, TimerTickOnce)
{
    ...
    ASSERT_EQ(rld ,0xffffffff);
    ASSERT_EQ(cnt ,0xfffffffe); // rld minus one
...
TEST_F(GPTIMERTest, TimerTicksPrescalerUnderflow)
{
    ...
    ASSERT_EQ(timer.Read(0x14) ,0xffffffff); // rld minus one
    ...
    ASSERT_EQ(timer.Read(0x10), 0xfffffffe);
    ASSERT_EQ(timer.Read(0x20), 0xffffffff);
    ASSERT_EQ(timer.Read(0x30), 0xffffffff);
    ASSERT_EQ(timer.Read(0x40), 0xffffffff);
    ASSERT_EQ(timer.Read(0x50), 0xffffffff);
    u32 r7 = timer.Read(0x60); ASSERT_EQ(r7, 0xffffffff);
    ASSERT_EQ(timer.Read(0x70), 0xffffffff);
}
...
TEST_F(GPTIMERTest, TimerEnableOthers)
{
    ...
    ASSERT_EQ(timer.Read(0x10), 0xfffffffe);
    ASSERT_EQ(timer.Read(0x20), 0xffffffff);
    ASSERT_EQ(timer.Read(0x30), 0xfffffffe);
    ASSERT_EQ(timer.Read(0x40), 0xffffffff);
    ASSERT_EQ(timer.Read(0x50), 0xfffffffe);
    u32 r7 = timer.Read(0x60); ASSERT_EQ(r7, 0xffffffff);
    ASSERT_EQ(timer.Read(0x70), 0xffffffff);
...
TEST_F(GPTIMERTest, TimerIRQOnUnderflow)
{
    ...
    ASSERT_EQ(timer.Read(0x60), 0xffffffff);
    ASSERT_EQ(timer.Read(0x70), 0xffffffff);
